...
<table border = "1">
	...
	<tr><td>과목 코드</td>
		<td><input type = "text" name = "id" style = "width : 100%"></td></tr>
	<tr><td>과목명</td>
		<td><input type = "text" name = "name" style = "width : 100%"></td></tr>
	<tr><td>학점</td>
		<td><input type = "text" name = "credit" style = "width : 100%"></td></tr>
	<tr><td>담당강사</td>
	...
	<tr><td>시작 시간</td>
		<td><input type = "text" name = "sh" style = "width : 100%"></td></tr>
	<tr><td>종료 시간</td>
		<td><input type = "text" name = "eh" style = "width : 100%"></td></tr>
	<tr>
	<td colspan = "2">
